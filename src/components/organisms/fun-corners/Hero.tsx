...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="from-[#0B1E38] to-[#173679]/40 absolute inset-0 bg-gradient-to-t" aria-hidden="true" />

      {/* 3. LAYER KONTEN: Cukup z-10 agar di atas background, sangat aman untuk Navbar */}
      <div className="relative z-10 flex min-h-[640px] w-full max-w-[1260px] flex-col items-center gap-10 py-12 text-center lg:min-h-[700px] 2xl:min-h-[916px] lg:gap-[52px] lg:py-[136px]">
        <div className="flex flex-col items-center gap-2 px-11 sm:px-10 lg:px-[90px]">
            {/* =< 768px */}
            <h2
                className="font-rubikone text-blue-cs-30 relative z-10 text-[48px] leading-[60px] sm:text-[64px] sm:leading-[68px] block lg:hidden"
            ...
            {/* >= 768px */}
            <h2
                className="font-rubikone text-blue-cs-30 relative z-10 lg:text-[88px] lg:leading-[112px] hidden lg:block"
